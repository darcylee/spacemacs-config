...
(defun darcylee/eh-ivy-return-recentf-index (dir)
...
(defun darcylee/eh-ivy-sort-file-function (x y)
  (let* ((x (concat ivy--directory x))
    ...
    (if (file-directory-p x)
        (if (file-directory-p y)
            (let ((x-recentf-index (darcylee/eh-ivy-return-recentf-index x))
                  (y-recentf-index (darcylee/eh-ivy-return-recentf-index y)))
...
(defun darcylee/ignore-dired-buffers (str)
