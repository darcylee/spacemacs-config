 ...
 '(org-agenda-custom-commands
   (quote
    (("w" . "任务安排")
     ...
     ("p" . "项目安排")
     ("pw" tags-todo "PROJECT+WORK+CATEGORY=\"Work\"" nil)
     ("pl" tags-todo "PROJECT+DREAM+CATEGORY=\"darcylee\"" nil)
     ("W" "Weekly Review"
      ((stuck "" nil)
